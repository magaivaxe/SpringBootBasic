...
import com.frankmoley.lil.learningspring.controllers.RoomReservationController;
...
public class RoomReservationControllerTest {
  ...
  public void getReservations() throws Exception {
    ...
    roomReservation.setLastName("toto");
    roomReservation.setFirstName("tata");
    ...
    .andExpect(content().string(containsString("toto, tata")));
  }
}
